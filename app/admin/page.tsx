...
export default async function Admin() {
  ...
  return <main className="min-h-screen bg-[#eeece4] px-4 py-5 md:px-8"><div className="mx-auto max-w-6xl">
    ...
    <div className="mt-10 grid gap-5 lg:grid-cols-[360px_1fr]">
      <form action={createProduct} encType="multipart/form-data" className="h-fit border border-black bg-white p-5"><h2 className="display text-3xl">Add a product</h2><p className="mt-2 text-xs leading-5 text-black/60">Add a clear product photo, name, price and stock. The image appears in the shop immediately after publishing.</p><div className="mt-6 grid gap-3">
